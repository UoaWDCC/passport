...
const postUserData = async (data: UserData) => {
  await fetch(`${import.meta.env.SERVER_URL}/api/user`, {
    method: "POST",
...
const updateUserData = async (data: UserData) => {
  try {
    const response = await fetch(
      `${import.meta.env.SERVER_URL}/api/user/` + data.UserUPI,
      {
        method: "PUT",
        headers: { "Content-type": "application/json" },
        body: JSON.stringify({
      ...
      try {
        ...
        if (
          ...
          const getUserData = async () => {
            ...
            await fetch(`${import.meta.env.SERVER_URL}/api/user/` + userUPI, {
              method: "GET",
            })
              .then((response) => {
                console.log(
