...
const QRErrorPage: React.FC = () => {
  ...
  const attendEvent = (eventId: string, upi: string) => {
    axios
      .post(`${import.meta.env.VITE_SERVER_URL}/api/attend-event`, {
            ...
            if (response.data.success) {
              ...
              axios
                .get(
                  ...
                  }/api/check-event-status/${eventId}`
                )
                .then((res) => {
                  console.log(res);
        ...
        {isLoading ? (
          ...
          <div className={styles.bottomsection}>
            ...
            <p className={styles.successsmall}>
              Successfully attended event :D{" "}
            </p>
            <button
              className={`${styles.continue_btn} ${styles.buttonFont}`}
              onClick={() => {
                navigate("/passport");
              }}
            >
